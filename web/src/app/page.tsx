    ...
    <div className="min-h-screen relative">
      ...
      <main className="bg-black w-full min-w-[1440px] min-h-[1024px] relative">
        ...
        <div className="absolute top-[580px] left-[82px] h-[72px] w-[500px] flex gap-4">
          <Button
            className="px-10 py-6 rounded-xl bg-[linear-gradient(180deg,rgba(54,146,59,1)_0%,rgba(39,174,46,1)_100%)] hover:bg-[linear-gradient(180deg,rgba(54,146,59,0.9)_0%,rgba(39,174,46,0.9)_100%)] border-0 text-lg font-medium cursor-pointer"
          ...
          <Button
            className="px-10 py-6 rounded-xl bg-white text-green-600 hover:bg-gray-100 transition-colors duration-200 text-lg font-medium cursor-pointer"
