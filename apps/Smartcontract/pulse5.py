...
class HackathonChickenDetector:
    def __init__(self, model_path='chick.pt', supabase_url=None, supabase_key=None):
        """Improved detector with proper Supabase integration"""
    ...
    def _initialize_camera(self):
        ...
        for camera_index in [0, 1, 2]:
            ...
            raise Exception(" No camera found! Make sure a camera is connected.")
    ...
    def _print_status(self, data, detections):
        ...
        if detections:
            ...
            for i, det in enumerate(detections, 1):
                confidence_emoji = "red" if det['confidence'] > 0.8 else "yellow" if det['confidence'] > 0.6 else "green"
...
if __name__ == "__main__":
    ...
    # Check configuration
    if "your-project" in SUPABASE_URL or "your-service-role" in SUPABASE_KEY:
        print("  WARNING: Using default Supabase credentials!")
        print("Please update SUPABASE_URL and SUPABASE_KEY in the code")
        print("unning in LOCAL MODE only...")
        SUPABASE_URL = None
        SUPABASE_KEY = None
