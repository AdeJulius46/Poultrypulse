            ...
            <div className="space-y-4 sm:space-y-6 w-full max-w-md mx-auto flex flex-col justify-center items-center">
              ...
              <div className="flex flex-col sm:flex-row w-full gap-4 font-normal text-[#404040]">
                ...
                <div className="flex flex-col items-start w-full sm:w-[40%] space-y-2">
                  <label htmlFor="Batch_Name" className="text-sm sm:text-base">
                    Batch Name
                  </label>
                  <input
                    type="text"
              ...
              <div className="flex w-full justify-between gap-2 sm:gap-4">
                ...
                <button
                  className="flex-1 sm:flex-none rounded-md bg-green-600 px-4 py-2 text-white hover:bg-green-700 transition-colors"
